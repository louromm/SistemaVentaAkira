...
namespace SistemaVentaAkira.Controller
{
    public class Usuario_controller
    {
        ...
        public Object[] consultarUsuario(int p_index)
        {
            using (Akira_IndumentariaEntities db = new Akira_IndumentariaEntities())
            {
                Usuario datosUsuario = db.Usuario.Include("Rol").Where(user => user.Id_usuario == p_index).First();

                Object[] usuario = { datosUsuario.Id_usuario, datosUsuario.Rol.rol_nombre, datosUsuario.Us_nombre, datosUsuario.Us_apellido, datosUsuario.Us_email, datosUsuario.Us_telefono, descencriptarClave(datosUsuario.Us_clave), datosUsuario.Us_fechaNacimiento, datosUsuario.Us_estado };
        ...
        public void AgregarUsuario(string p_rol, string p_nombre, string p_apellido, string p_email, string p_telefono, string p_clave, DateTime p_fechaNacimiento)
        {
            using (Akira_IndumentariaEntities db = new Akira_IndumentariaEntities())
            {
        ...
        public void modificarUsuario(int p_index, string p_rol, string p_nombre, string p_apellido, string p_email, string p_telefono, string p_clave, DateTime p_fechaNacimiento)
        {
            using (Akira_IndumentariaEntities db = new Akira_IndumentariaEntities())
            {
        ...
        public bool verificarLoggin(string p_email, string p_clave)
        {
            using (Akira_IndumentariaEntities db = new Akira_IndumentariaEntities())
            {
                ...
                Usuario datosUsuario = db.Usuario.Where(user => user.Us_email == p_email && user.Us_clave == claveEncriptada).FirstOrDefault();
        ...
        public Object[] obtenerUsuario(string p_email, string p_clave)
        {
            using (Akira_IndumentariaEntities db = new Akira_IndumentariaEntities())
            {
                string claveEncriptada = encriptarClave(p_clave);
                Usuario datosUsuario = db.Usuario.Include("Rol").Where(user => user.Us_email == p_email && user.Us_clave == claveEncriptada).First();

                Object[] usuario = { datosUsuario.Id_usuario, datosUsuario.Rol.rol_nombre, datosUsuario.Us_nombre, datosUsuario.Us_apellido, datosUsuario.Us_email };
