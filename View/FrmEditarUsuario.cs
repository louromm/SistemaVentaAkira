...
namespace SistemaVentaAkira.View
{
    public partial class FrmEditarUsuario : Form
    {
        ...
        private void btnModificarUsuario_Click(object sender, EventArgs e)
        {
            if (this.validarCampos())
            {
                ...
                if (controlador_usuario.validacionEmailEdit(Convert.ToInt32(tbIDUser.Text), tbEmailUsuario.Text)) {
                    controlador_usuario.modificarUsuario(Convert.ToInt32(tbIDUser.Text), cbRolUsuario.Text, tbNombreUsuario.Text, tbApellidoUsuario.Text, tbEmailUsuario.Text, tbTelefonoUsuario.Text, tbClaveUsuario.Text, dtp_nacimientoUsuario.Value);
        ...
        private void cargarCampos(int p_index)
        {
            ...
            tbEmailUsuario.Text = usuario[4].ToString();
            tbTelefonoUsuario.Text = usuario[5].ToString();
            tbClaveUsuario.Text = usuario[6].ToString();
            dtp_nacimientoUsuario.Text = usuario[7].ToString();
