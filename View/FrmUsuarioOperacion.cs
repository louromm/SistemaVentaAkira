        ...
        private void btnRegistrarUsuario_Click(object sender, EventArgs e)
        {
            if (this.validarCampos()){
                ...
                if (controlador_usuario.validacionEmailRegistro(tbEmailUsuario.Text)) {
                    controlador_usuario.AgregarUsuario(cbRolUsuario.Text, tbNombreUsuario.Text, tbApellidoUsuario.Text, tbEmailUsuario.Text, tbTelefonoUsuario.Text, tbClaveUsuario.Text, dtp_nacimientoUsuario.Value);
